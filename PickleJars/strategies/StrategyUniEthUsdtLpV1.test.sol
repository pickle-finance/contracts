// hevm: flattened sources of src/tests/strategy-uni-eth-usdt-lp-v1.test.sol
...
////// src/tests/strategy-uni-eth-usdt-lp-v1.test.sol
/* pragma solidity ^0.6.7; */
...
/* import "../strategies/strategy-uni-eth-usdt-lp-v1.sol"; */
...
contract StrategyUniEthUsdtpV1Test is DSTestApprox {
    ...
    StrategyUniEthUsdtLpV1 strategy;
    ...
    function setUp() public {
        ...
        strategy = new StrategyUniEthUsdtLpV1(
            governance,
            strategist,
            address(controller)
        );
