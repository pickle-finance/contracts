// hevm: flattened sources of src/tests/strategy-uni-eth-dai-lp-v1.test.sol
...
////// src/tests/strategy-uni-eth-dai-lp-v1.test.sol
/* pragma solidity ^0.6.7; */
...
/* import "../strategies/strategy-uni-eth-dai-lp-v1.sol"; */

contract StrategyUniEthDaiLpV1Test is DSTestApprox {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    ...
    StrategyUniEthDaiLpV1 strategy;
    ...
    function setUp() public {
        ...
        strategy = new StrategyUniEthDaiLpV1(
            governance,
            strategist,
            address(controller)
        );
