// hevm: flattened sources of src/tests/strategy-uni-eth-usdc-lp-v1.test.sol
pragma solidity >=0.4.23 >=0.6.0 <0.7.0 >=0.6.2 <0.7.0 >=0.6.7 <0.7.0;

////// src/tests/strategy-uni-eth-usdc-lp-v1.test.sol
...
import "../strategies/strategy-uni-eth-usdc-lp-v1.sol";

contract StrategyUniEthUsdcpV1Test is DSTestApprox {
    ...
    StrategyUniEthUsdcLpV1 strategy;
    ...
    function setUp() public {
        ...
        strategy = new StrategyUniEthUsdcLpV1(
            governance,
            strategist,
            address(controller)
        );
