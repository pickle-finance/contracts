// hevm: flattened sources of src/strategies/curve/strategy-curve-scrv-v4.sol
...
////// src/strategies/curve/strategy-curve-scrv-v4.sol
...
contract StrategyCurveSCRVv4 {
    ...
    // 0.5% fee on withdrawal
    uint256 public treasuryFee = 325;
    uint256 public constant treasuryMax = 100000;

    address public constant dev = 0x9d074E37d408542FD38be78848e8814AFB38db17;
    uint256 public constant devFee = 175;
    uint256 public constant devMax = 100000;
    ...
    function withdraw(uint256 _amount) external {
        ...
        uint256 _feeDev = _amount.mul(devFee).div(devMax);
        IERC20(want).safeTransfer(dev, _feeDev);

        address _jar = IController(controller).jars(address(want));
        require(_jar != address(0), "!jar"); // additional protection so we don't burn the funds

        IERC20(want).safeTransfer(_jar, _amount.sub(_feeTreasury).sub(_feeDev));
    }
